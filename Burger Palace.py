...
name = input ("Hello there, I'm {}! What's your name? ".format(attname)) #Displaying the attentand name generated by a random choice of names from a list
...
def burgerchoice ():
    ...
    while True:
        ...
        if (choice1 == 'yes') or (choice1 == 'yeah') or (choice1 == 'y'):
            ...
            print ("Sorry, I didn't understand, would like a burger, yes or no? ")
            continue
...
total = total + (burgerprice * burgers) + (bevprice * bevammount)
